...
@Tag(name = "post API",description = "게시물 조회,등록및 수정,삭제 api 입니다.")
@RestController
@Slf4j
...
public class PostApiController {
    ...
    @Parameters({
            ...
            @Parameter(name = "content", description = "게시물의 내용 쓰세요", example = "내용내용"),
    ...
    public  ResponseEntity<?> create(
        ...
        try {
            //위에 존재하는 if 문을 모두 건너뜀 ->  dto가 null도 아니고,입력값 검증도 모두 통과함 -> service 에게 명령
    ...
    public  ResponseEntity<?> delete(@PathVariable Long id){
        ...
        try {
            ...
            return  ResponseEntity.ok("DEL SUCESS!!");
        }
//        catch (SQLIntegrityConstraintViolationException e){
//            return  ResponseEntity.internalServerError()
//                    .body("해시태그가 달린 게시물은 삭제할 수 업습니다.")
//        }
        catch (Exception e) {
            e.printStackTrace();
            return  ResponseEntity.internalServerError()
