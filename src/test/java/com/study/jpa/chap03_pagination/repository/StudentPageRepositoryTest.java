...
@SpringBootTest
//JPA 는 INSERT,UPDATE,DELETE 시에 트랜젹션을 기준으로 동작하는 경우가 많음.
//기능을 보장받기 위해소는 왠만하면 트랜젝션 기능을 함께 사용해야 합니다.
//나중에 MVC  구조 에서는 SERVICE  클래스에 아노테이션을 첨부하면 됩니다.
@Transactional
@Rollback(false)
...
//    }
    ...
    void  testBasicPagination() {
        ...
        Pageable pageInfo = PageRequest.of(pageNo - 1,
                amount,
//                Sort.by("name").descending() //정령 기준 필드명! 컬럼(x)
                Sort.by(
        ...
        //다음 페이지
        boolean b = students.hasNext();
        //이전 페이지
        boolean b1 = students.hasPrevious();

        //then
        System.out.println("\n\n\n");
        System.out.println("b1 = " + b1);
        System.out.println("b1 = " + totalPages);
